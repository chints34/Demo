...
void switch_test()
   ...
   TST:print("Enter any key to test Switchs...\n\r");
	...
	if(ch==4) //ch will be 4 when all 4 switches are tested. 
        {
			ch=0;
		    ...
		    {
		    print("Invalid key is entered!try again\n\r");
			goto SWT;
		    }
  ...
  print("within 100ms of time to test\n\r");
   ...
   for(i=2000;i>0;i--)
	...
	print("see WHETHER the switch entered by you is equal to the switch display?\n\r");
...
MET:  print("Enter (y)for yes and (n) for no\n\r");
	   ...
	   SWT:print("Do you want to continue to test next switch?\n\r");
   
	   print("press(y)for Yes and (n)for exit\n\r");
